...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "ENTIS"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  config.google_analytics_page_code = "UA-36900190-1"
  ...
  # config.dragonfly_secret = "8b0ae7fbd1df73059b60b34fcf3003d776154876400ef5d9"
  ...
  config.register_stylesheet "custom_backend", :media => 'screen'
end
